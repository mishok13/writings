...
\begin{frame}
  ...
  \only<7>{
    This should produce nice image
    \begin{center}
...
\begin{frame}
  ...
  \only<2>{
    Or just use spatialreference.org
  }
\end{frame}
...
\begin{frame}
  ...
  \only<4>{
    \includegraphics{pycon-2011-tutorial-files/hw-crippled.png}
  }
\end{frame}
...
\begin{frame}
  ...
  \only<5>{
    \includegraphics{pycon-2011-tutorial-files/hw-fixed.png}
  }
\end{frame}
