...
def main():
    ...
    coords = (Coord(-0.1, 51.49), Coord(-0.08, 51.51))
    # coords = (Coord(-84.3875530, 33.7615510),
    #           Coord(-84.3875530, 33.7615510))
    image = render_map(load(sys.argv[1]),
                       project(coords, projection), 1200, 1200)
